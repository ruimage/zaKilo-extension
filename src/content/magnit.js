class MagnitProductCard {
    ...
    _parseQuantityFromName(text) {
        ...
        switch (unit) {
            ...
            case 'шт': return { unitLabel: '1 шт', multiplier: 1 / value };
            default: return { unitLabel: `1 ${unit}`, multiplier: 1 / value };
        }
    }
}
...
(function() {
    if (document.readyState === 'loading')
        document.addEventListener('DOMContentLoaded', () => MagnitProductCard.init());
